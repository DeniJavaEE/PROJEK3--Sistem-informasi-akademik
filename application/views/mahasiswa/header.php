...
<?php
$usr = $this->db->get_where('tbl_mahasiswa', array('nim' => $this->session->userdata('nim')))->row_array();
$foto = 'default.jpg';
	...
	<div class="wrapper">
		<header class="main-header">
			...
			<a href="javascript:void(0)" class="logo">
				...
				<span class="logo-lg"><b>PANEL</b> MAHASISWA</span>
			</a>
					...
					<ul class="nav navbar-nav">
						...
						<li class="dropdown user user-menu">
							<a href="javascript:void(0)" class="dropdown-toggle" data-toggle="dropdown">
								...
								<span class="hidden-xs"><?=$usr['nama_mhs']?></span>
							</a>
							<ul class="dropdown-menu">
								...
								<li class="user-footer">
									<div class="pull-left">
										<a href="<?=base_URL()?>mahasiswa/profil_saya" class="btn btn-default btn-flat">Profil Saya</a>
									</div>
			...
			<section class="sidebar">
				...
				<ul class="sidebar-menu" data-widget="tree">
					...
					<li <?php if($this->uri->segment(2)=="dashboard") { echo 'class="active"'; } ?>>
						<a href="<?=base_URL()?>mahasiswa/dashboard"><i class="fa fa-dashboard"></i> <span>Dashboard</span></a>
					</li>
					<li <?php if($this->uri->segment(2)=="nilai" || $this->uri->segment(2)=="nilai_lihat") { echo 'class="active"'; } ?>>
						<a href="<?=base_URL()?>mahasiswa/nilai"><i class="fa fa-calculator"></i> <span>Nilai</span></a>
					</li>
					<li class="header">MENU PENGGUNA</li>
					<li <?php if($this->uri->segment(2)=="profil_saya") { echo 'class="active"'; } ?>>
						<a href="<?=base_URL()?>mahasiswa/profil_saya"><i class="fa fa-user-circle text-aqua"></i> <span>Profil Saya</span></a>
					</li>
